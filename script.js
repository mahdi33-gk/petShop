...
const btnShower = (id) => {
    ...
    id.forEach(btn => {
        ...
        div.className = ""
        div.innerHTML = `
        <button id="btn-${btn.category}" onclick="loadcategoryData('${btn.category}')"  class="btn categoryBtn px-3 flex justify-center items-center md:px-14 border-borderCl py-1 md:py-3 h-auto">
